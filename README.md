...
`exemplos/pedido-sem-estoque.json`. O token fictício `RECUSAR` simula um pagamento não autorizado,
enquanto `APROVAR` segue pelo fluxo de aprovação. Nenhum número de cartão real deve ser informado.
